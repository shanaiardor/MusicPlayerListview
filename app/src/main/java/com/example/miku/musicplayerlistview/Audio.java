...
public class Audio {
    ...
    public Audio (Bundle bundle) {
        ...
        mArtist = bundle.getString(MediaStore.Audio.Media.ARTIST); //艺术家
        mArtistKey = bundle.getString(MediaStore.Audio.Media.ARTIST_KEY);
        mComposer = bundle.getString(MediaStore.Audio.Media.COMPOSER);// 作曲家
        mAlbum = bundle.getString(MediaStore.Audio.Media.ALBUM);//唱片
        ...
        mDuration = bundle.getInt(MediaStore.Audio.Media.DURATION); //时长
